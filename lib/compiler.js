...
// NOTE: import.meta.resolve returns a file:// URL string, so fileURLToPath is needed to convert it
...
export function compileToWasm(inputJs, outputWasm, temp) {
	...
	// NOTE: DEP0190 warning ("Passing args to a child process with shell option true") is emitted
	// by @fastly/js-compute internally — hardcoded shell:true in dist/compileApplicationToWasm.js
	// for Windows path compatibility. Not fixable from our side; upstream issue.
	try {
